...
public interface ISvgAssetCollector
{
    ...
    /// <param name="attributes">Dictionary representing desired SVG element attributes to be added.</param>
    /// <param name="useCache">
    ...
    /// </returns>
    Task<SvgResult> GetSvgAssetAsync(string? filename, Dictionary<string, string>? attributes = null,
